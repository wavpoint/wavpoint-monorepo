    ...
    <Layout>
      <div className="grid w-11/12 md:grid-cols-9 max-w-5xl mx-auto gap-x-20 gap-y-20 mb-32">
        ...
        <div className="col-span-full md:col-span-4 md:row-start-2 order-3">
          <div>
            <h2 className="font-medium text-lg text-orange mb-3">
              Description
            </h2>
        ...
        <div className="col-span-full md:col-span-5 md:col-start-5 md:row-span-1 md:row-start-1">
          ...
          <div className="flex flex-col items-center md:items-start md:flex-row gap-3 md:gap-6 mt-12">
            <Button className="rounded-full w-fit mx-auto md:mx-0 flex items-center py-8 md:py-2 px-12 gap-1">
              <IconLockOpen />
              <span className="text-base md:text-xs border-[#222222]">
                Track IDs & Video
              </span>
            </Button>
            <Button className="rounded-full w-fit mx-auto md:mx-0  text-orange text-xs bg-[#F5F5F5] px-6">
              14 Collected
            </Button>
          </div>
          <div className="hidden md:block">
        ...
        <div className="col-span-full md:col-span-5 md:col-start-5 md:row-start-2 order-3">
          <div>
            ...
            <ul className="flex flex-col gap-5">
              ...
              <li className=" text-sm font-normal">Habitzz - Buddy</li>
              <li className=" text-sm font-normal">
        ...
        <div className="my-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className=" text-sm">0x0000...000</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-orange  text-sm">1 hr</span>
        ...
        <div className="my-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className=" text-sm">wavthe0ry.eth</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-orange  text-sm">1 hr</span>
              <IconArrowUpRight stroke="#FF6700" />
          ...
          <p className="mt-4  text-sm">First to collect!!!</p>
        </div>
        <span className="block text-center  text-xs text-orange mt-6">
          show more
        </span>
      </div>
    </div>
