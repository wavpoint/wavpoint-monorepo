...
>(({ className, ...props }, ref) => (
    ...
    >
        ...
        <SliderPrimitive.Thumb className="cursor-grab active:cursor-grabbing block h-[13px] w-[3px] bg-primary ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50" />
    </SliderPrimitive.Root>
))
