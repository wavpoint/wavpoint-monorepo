...
import { Button, Dialog, DialogContent, DialogTrigger, Drawer, DrawerContent, DrawerTrigger, Progress, Row, Text, View, buttonVariants } from "@repo/app/ui";
...
export function MixScreen() {
    ...
    return (
        <DefaultLayout>
            <View className="max-w-2xl items-center gap-2 flex-1 w-full overflow-y-scroll">
                ...
                <Row className='px-0 items-center'>
                    <Text className="text-sm font-bold underline">S{id} - Lootmatic & Trucalyptus</Text>
    ...
    return (
        <Drawer open={open} onOpenChange={setOpen}>
            <DrawerTrigger asChild>
                <Text className={cn(buttonVariants({ variant: 'outline' }), 'cursor-pointer border-primary text-primary font-semibold')}>🟣 Mint +</Text>
            </DrawerTrigger>
            <DrawerContent>
                <MintDialogContent />
            </DrawerContent>
